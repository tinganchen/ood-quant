...
def main():
    ...
    if args.mixed == 'False':
        ...
        id_score_file = os.path.join(args.job_dir, f"out_scores_{args.dataset}_{args.ood_method}.txt")
    ...
    '''
        ...
        data_csv = os.path.join(args.csv_dir_mixed, f'cifar100_{args.ood_dataset}_test.csv')
