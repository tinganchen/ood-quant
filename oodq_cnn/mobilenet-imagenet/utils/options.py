...
OOD_dataset = 'Places' # iNaturalist, SUN, Places, texture
...
parser.add_argument('--source_file', type = str, default = 'mobilenet/t_32_0/checkpoint/model_best.pt', help = 'The file the teacher model weights saved as.')
...
parser.add_argument('--target_model', type = str, default = 'mobilenet_v2', help = 'The target model.')
...
parser.add_argument('--act_clip_p_l', type = float, default = ACT_CLIP_P_L, help = 'Scale the sigmoid function.')
